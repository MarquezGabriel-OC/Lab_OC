...
section .data 
msg_captura   db  10 'Ingresa una cadena (max 63 caracteres) y preciona ENTER: ', 0
msg_mayuscula db  10 'Texto en mayuscula: ', 0
msg_minuscula db 'Texto en minuscula: ', 0
...
mov edc, cadena        ; imprimir cadena modificada Mayuscula
call puts 
...
.Ciclo_Mayuscula 
    mov al, byt [edc + ecx]  ;tomamos letra actual 
    cmp al, 0 
    je .fin_mayus

    cmp al, 'a'
    jl .siguente_mayus       ; si es mayuscula pasa a la siguente letra / jl= si  (al)  es menor a 'a'
    cmp al, 'z'
    jg .siguente_mayus       ; si es mayuscula pasa a la siguente letra / jg= si  (al)  es mayor a 'z'
